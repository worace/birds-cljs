...
birds_cljs.flock.PI = Math.PI;
birds_cljs.flock.TWO_PI = ((2) * Math.PI);
...
return cljs.core.take.call(null,n,cljs.core.repeatedly.call(null,birds_cljs.bird.create_bird));
});
...
;
birds_cljs.flock.neighbors = (function() {
var neighbors = null;
var neighbors__2 = (function (bird,flock){
return neighbors.call(null,bird,flock,birds_cljs.flock.neighborhood_radius);
});
var neighbors__3 = (function (bird,flock,radius){
return cljs.core.filter.call(null,(function (flockmate){
return (!(cljs.core._EQ_.call(null,bird,flockmate))) && ((birds_cljs.flock.dist.call(null,new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(bird),new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(flockmate)) < radius));
}),flock);
});
...
;
birds_cljs.flock.crowded_QMARK_ = (function() {
var crowded_QMARK_ = null;
var crowded_QMARK___2 = (function (bird,crowders){
return crowded_QMARK_.call(null,bird,crowders,birds_cljs.flock.separation_radius);
});
var crowded_QMARK___3 = (function (bird,crowders,radius){
return !(cljs.core.empty_QMARK_.call(null,birds_cljs.flock.neighbors.call(null,bird,crowders,radius)));
});
...
;
birds_cljs.flock.avg_position = (function avg_position(group){
...
birds_cljs.flock.avg_heading = (function avg_heading(group){
...
birds_cljs.flock.straying_QMARK_ = (function() {
var straying_QMARK_ = null;
var straying_QMARK___2 = (function (bird,buddies){
return straying_QMARK_.call(null,bird,buddies,birds_cljs.flock.straying_radius);
});
var straying_QMARK___3 = (function (bird,buddies,radius){
return (birds_cljs.flock.dist.call(null,new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(bird),birds_cljs.flock.avg_position.call(null,buddies)) > radius);
});
...
;
birds_cljs.flock.angle_to_position = (function angle_to_position(coords){
...
birds_cljs.flock.steer_toward_position = (function steer_toward_position(bird,position){
if((birds_cljs.flock.angle_to_position.call(null,new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(bird)) < birds_cljs.flock.angle_to_position.call(null,position))){
return cljs.core.assoc.call(null,bird,new cljs.core.Keyword(null,"dir","dir",1734754661),birds_cljs.flock.direction.call(null,(new cljs.core.Keyword(null,"dir","dir",1734754661).cljs$core$IFn$_invoke$arity$1(bird) + 0.1)));
} else {
return cljs.core.assoc.call(null,bird,new cljs.core.Keyword(null,"dir","dir",1734754661),birds_cljs.flock.direction.call(null,(new cljs.core.Keyword(null,"dir","dir",1734754661).cljs$core$IFn$_invoke$arity$1(bird) - 0.1)));
}
});
birds_cljs.flock.steer_from_position = (function steer_from_position(bird,position){
if((birds_cljs.flock.angle_to_position.call(null,new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(bird)) < birds_cljs.flock.angle_to_position.call(null,position))){
return cljs.core.assoc.call(null,bird,new cljs.core.Keyword(null,"dir","dir",1734754661),birds_cljs.flock.direction.call(null,(new cljs.core.Keyword(null,"dir","dir",1734754661).cljs$core$IFn$_invoke$arity$1(bird) - 0.1)));
} else {
return cljs.core.assoc.call(null,bird,new cljs.core.Keyword(null,"dir","dir",1734754661),birds_cljs.flock.direction.call(null,(new cljs.core.Keyword(null,"dir","dir",1734754661).cljs$core$IFn$_invoke$arity$1(bird) + 0.1)));
...
birds_cljs.flock.steer_toward_avg_heading = (function steer_toward_avg_heading(bird,neighbors){
var avg = birds_cljs.flock.avg_heading.call(null,neighbors);
...
return birds_cljs.flock.steer_toward_position.call(null,bird,nearby_avg);
} else {
return birds_cljs.flock.steer_toward_avg_heading.call(null,bird,nearby);
}
}
}
});
birds_cljs.flock.adjust_courses = (function adjust_courses(flock){
return cljs.core.map.call(null,cljs.core.partial.call(null,birds_cljs.flock.adjust_course,flock),flock);
});
birds_cljs.flock.move_flock = (function move_flock(flock){
return cljs.core.map.call(null,(function (bird){
return birds_cljs.bird.move_bird.call(null,bird);
}),flock);
});
birds_cljs.flock.update_flock = (function update_flock(flock){
return birds_cljs.flock.move_flock.call(null,birds_cljs.flock.adjust_courses.call(null,flock));
});
