...
goog.provide('birds.bird');
goog.require('cljs.core');
goog.require('quil.core');
birds.bird.create_bird = (function create_bird(){
...
birds.bird.next_position = (function next_position(bird){
...
birds.bird.move_bird = (function move_bird(bird){
return cljs.core.assoc.call(null,bird,new cljs.core.Keyword(null,"position","position",-2011731912),birds.bird.next_position.call(null,bird));
});
birds.bird.movement_vector = (function movement_vector(bird){
return cljs.core.concat.call(null,new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(bird),birds.bird.next_position.call(null,bird));
});
birds.bird.movement_vector = (function movement_vector(bird){
return cljs.core.concat.call(null,new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(bird),birds.bird.next_position.call(null,bird));
});
birds.bird.rotate_bird = (function rotate_bird(bird){
