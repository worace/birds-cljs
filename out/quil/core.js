...
*/
quil.core.current_graphics = (function current_graphics(){
var or__3759__auto__ = quil.core._STAR_graphics_STAR_;
...
*/
quil.core.prc_println = (function prc_println(msg){
...
* (state :foo) ;=> 2
*/
quil.core.state_atom = (function state_atom(){
...
var state = null;
var state__0 = (function (){
return cljs.core.deref.call(null,quil.core.state_atom.call(null));
});
var state__1 = (function (key){
var state__$1 = state.call(null);
if(cljs.core.contains_QMARK_.call(null,state__$1,key)){
} else {
...
var set_state_BANG___delegate = function (state_vals){
...
var G__11964__i = 0, G__11964__a = new Array(arguments.length -  0);
while (G__11964__i < G__11964__a.length) {G__11964__a[G__11964__i] = arguments[G__11964__i + 0]; ++G__11964__i;}
  state_vals = new cljs.core.IndexedSeq(G__11964__a,0);
} 
return set_state_BANG___delegate.call(this,state_vals);};
set_state_BANG_.cljs$lang$maxFixedArity = 0;
set_state_BANG_.cljs$lang$applyTo = (function (arglist__11965){
var state_vals = cljs.core.seq(arglist__11965);
...
*/
quil.core.acos = (function acos(n){
return quil.sketch.current_applet.call(null).acos(n);
});
/**
* Extracts the alpha value from a color.
*/
quil.core.alpha = (function alpha(color){
return quil.core.current_graphics.call(null).alpha((color | (0)));
});
/**
...
var ambient_float__1 = (function (gray){
return quil.core.current_graphics.call(null).ambient(gray);
});
var ambient_float__3 = (function (x,y,z){
...
*/
quil.core.ambient_int = (function ambient_int(rgb){
...
var ambient = null;
var ambient__1 = (function (rgb){
return quil.core.ambient_float.call(null,rgb);
});
var ambient__3 = (function (x,y,z){
...
var ambient_light__3 = (function (red,green,blue){
return quil.core.current_graphics.call(null).ambientLight(red,green,blue);
});
var ambient_light__6 = (function (red,green,blue,x,y,z){
...
*/
quil.core.apply_matrix = (function apply_matrix(n00,n01,n02,n03,n10,n11,n12,n13,n20,n21,n22,n23,n30,n31,n32,n33){
...
*/
quil.core.arc = (function arc(x,y,width,height,start,stop){
...
*/
quil.core.asin = (function asin(n){
...
* PI/2 .
*/
quil.core.atan = (function atan(n){
...
*/
quil.core.atan2 = (function atan2(y,x){
...
*/
quil.core.available_fonts = (function available_fonts(){
...
var background_int__1 = (function (rgb){
return quil.core.current_graphics.call(null).background((rgb | (0)));
});
var background_int__2 = (function (rgb,alpha){
return quil.core.current_graphics.call(null).background((rgb | (0)),alpha);
});
...
*/
quil.core.background_image = (function background_image(img){
...
*/
quil.core.begin_camera = (function begin_camera(){
...
* renderers.
*/
quil.core.begin_contour = (function begin_contour(){
...
var begin_shape__0 = (function (){
return quil.core.current_graphics.call(null).beginShape();
});
var begin_shape__1 = (function (mode){
...
var bezier = null;
var bezier__8 = (function (x1,y1,cx1,cy1,cx2,cy2,x2,y2){
return quil.core.current_graphics.call(null).bezier(x1,y1,cx1,cy1,cx2,cy2,x2,y2);
});
var bezier__12 = (function (x1,y1,z1,cx1,cy1,cz1,cx2,cy2,cz2,x2,y2,z2){
...
* information.
*/
quil.core.bezier_detail = (function bezier_detail(detail){
...
*/
quil.core.bezier_point = (function bezier_point(a,b,c,d,t){
...
*/
quil.core.bezier_tangent = (function bezier_tangent(a,b,c,d,t){
...
var bezier_vertex__6 = (function (cx1,cy1,cx2,cy2,x,y){
return quil.core.current_graphics.call(null).bezierVertex(cx1,cy1,cx2,cy2,x,y);
});
var bezier_vertex__9 = (function (cx1,cy1,cz1,cx2,cy2,cz2,x,y,z){
...
var binary = null;
var binary__1 = (function (val){
return quil.sketch.current_applet.call(null).binary(val);
});
var binary__2 = (function (val,num_digits){
...
var blend = null;
var blend__9 = (function (x,y,width,height,dx,dy,dwidth,dheight,mode){
return blend.call(null,quil.core.current_graphics.call(null),quil.core.current_graphics.call(null),x,y,width,height,dx,dy,dwidth,dheight,mode);
});
var blend__10 = (function (src_img,x,y,width,height,dx,dy,dwidth,dheight,mode){
return blend.call(null,src_img,quil.core.current_graphics.call(null),x,y,width,height,dx,dy,dwidth,dheight,mode);
});
var blend__11 = (function (src_img,dest_img,x,y,width,height,dx,dy,dwidth,dheight,mode){
...
* Photoshop.
*/
quil.core.blend_color = (function blend_color(c1,c2,mode){
var mode_11966__$1 = quil.util.resolve_constant_key.call(null,mode,quil.core.blend_modes);

return quil.core.current_graphics.call(null).blendColor(c1,c2,mode);
});
/**
* Extracts the blue value from a color, scaled to match current color-mode.
* Returns a float.
*/
quil.core.blue = (function blue(color){
return quil.core.current_graphics.call(null).blue((color | (0)));
});
/**
...
var box = null;
var box__1 = (function (size){
return quil.core.current_graphics.call(null).box(size);
});
var box__3 = (function (width,height,depth){
...
*/
quil.core.brightness = (function brightness(color){
return quil.core.current_graphics.call(null).brightness((color | (0)));
});
/**
...
var camera = null;
var camera__0 = (function (){
return quil.core.current_graphics.call(null).camera();
});
var camera__9 = (function (eyeX,eyeY,eyeZ,centerX,centerY,centerZ,upX,upY,upZ){
...
* value 10.
*/
quil.core.ceil = (function ceil(n){
...
var color_mode = null;
var color_mode__1 = (function (mode){
...
*/
quil.core.constrain = (function constrain(amt,low,high){
...
var copy = null;
var copy__2 = (function (p__11967,p__11968){
var vec__11979 = p__11967;
var sx = cljs.core.nth.call(null,vec__11979,(0),null);
var sy = cljs.core.nth.call(null,vec__11979,(1),null);
var swidth = cljs.core.nth.call(null,vec__11979,(2),null);
var sheight = cljs.core.nth.call(null,vec__11979,(3),null);
var vec__11980 = p__11968;
var dx = cljs.core.nth.call(null,vec__11980,(0),null);
var dy = cljs.core.nth.call(null,vec__11980,(1),null);
var dwidth = cljs.core.nth.call(null,vec__11980,(2),null);
var dheight = cljs.core.nth.call(null,vec__11980,(3),null);
return copy.call(null,quil.core.current_graphics.call(null),quil.core.current_graphics.call(null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [sx,sy,swidth,sheight], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [dx,dy,dwidth,dheight], null));
});
var copy__3 = (function (src_img,p__11969,p__11970){
var vec__11981 = p__11969;
var sx = cljs.core.nth.call(null,vec__11981,(0),null);
var sy = cljs.core.nth.call(null,vec__11981,(1),null);
var swidth = cljs.core.nth.call(null,vec__11981,(2),null);
var sheight = cljs.core.nth.call(null,vec__11981,(3),null);
var vec__11982 = p__11970;
var dx = cljs.core.nth.call(null,vec__11982,(0),null);
var dy = cljs.core.nth.call(null,vec__11982,(1),null);
var dwidth = cljs.core.nth.call(null,vec__11982,(2),null);
var dheight = cljs.core.nth.call(null,vec__11982,(3),null);
return copy.call(null,src_img,quil.core.current_graphics.call(null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [sx,sy,swidth,sheight], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [dx,dy,dwidth,dheight], null));
});
var copy__4 = (function (src_img,dest_img,p__11971,p__11972){
var vec__11983 = p__11971;
var sx = cljs.core.nth.call(null,vec__11983,(0),null);
var sy = cljs.core.nth.call(null,vec__11983,(1),null);
var swidth = cljs.core.nth.call(null,vec__11983,(2),null);
var sheight = cljs.core.nth.call(null,vec__11983,(3),null);
var vec__11984 = p__11972;
var dx = cljs.core.nth.call(null,vec__11984,(0),null);
var dy = cljs.core.nth.call(null,vec__11984,(1),null);
var dwidth = cljs.core.nth.call(null,vec__11984,(2),null);
var dheight = cljs.core.nth.call(null,vec__11984,(3),null);
return dest_img.copy(src_img,(sx | (0)),(sy | (0)),(swidth | (0)),(sheight | (0)),(dx | (0)),(dy | (0)),(dwidth | (0)),(dheight | (0)));
});
copy = function(src_img,dest_img,p__11971,p__11972){
switch(arguments.length){
case 2:
return copy__2.call(this,src_img,dest_img);
case 3:
return copy__3.call(this,src_img,dest_img,p__11971);
case 4:
return copy__4.call(this,src_img,dest_img,p__11971,p__11972);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
*/
quil.core.cos = (function cos(angle){
...
* directly.
*/
quil.core.create_image = (function create_image(w,h,format){
...
*/
quil.core.current_fill = (function current_fill(){
return quil.core.current_graphics.call(null).fillColor();
});
/**
* Return the current stroke color.
*/
quil.core.current_stroke = (function current_stroke(){
...
var cursor = null;
var cursor__0 = (function (){
return quil.sketch.current_applet.call(null).cursor();
});
var cursor__1 = (function (cursor_mode){
...
var cursor_image__1 = (function (img){
return quil.sketch.current_applet.call(null).cursor(img);
});
var cursor_image__3 = (function (img,hx,hy){
...
var curve = null;
var curve__8 = (function (x1,y1,x2,y2,x3,y3,x4,y4){
return quil.core.current_graphics.call(null).curve(x1,y1,x2,y2,x3,y3,x4,y4);
});
var curve__12 = (function (x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4){
...
* information.
*/
quil.core.curve_detail = (function curve_detail(detail){
...
*/
quil.core.curve_point = (function curve_point(a,b,c,d,t){
...
* See: http://en.wikipedia.org/wiki/Tangent
*/
quil.core.curve_tangent = (function curve_tangent(a,b,c,d,t){
...
*/
quil.core.curve_tightness = (function curve_tightness(ti){
...
var curve_vertex__2 = (function (x,y){
return quil.core.current_graphics.call(null).curveVertex(x,y);
});
var curve_vertex__3 = (function (x,y,z){
...
*/
quil.core.degrees = (function degrees(radians){
...
* inside setup.
*/
quil.core.delay_frame = (function delay_frame(freeze_ms){
...
*/
quil.core.directional_light = (function directional_light(r,g,b,nx,ny,nz){
...
var dist = null;
var dist__4 = (function (x1,y1,x2,y2){
return quil.sketch.current_applet.call(null).dist(x1,y1,x2,y2);
});
var dist__6 = (function (x1,y1,z1,x2,y2,z2){
...
*/
quil.core.ellipse = (function ellipse(x,y,width,height){
...
*/
quil.core.ellipse_mode = (function ellipse_mode(mode){
...
var emissive_float__1 = (function (float_val){
return quil.core.current_graphics.call(null).emissive(float_val);
});
var emissive_float__3 = (function (r,g,b){
...
* args to ints
*/
quil.core.emissive_int = (function emissive_int(int_val){
...
var emissive = null;
var emissive__1 = (function (c){
return quil.core.emissive_float.call(null,c);
});
var emissive__3 = (function (r,g,b){
...
*/
quil.core.end_camera = (function end_camera(){
...
* renderers.
*/
quil.core.end_contour = (function end_contour(){
...
*/
quil.core.end_raw = (function end_raw(){
...
var end_shape = null;
var end_shape__0 = (function (){
return quil.core.current_graphics.call(null).endShape();
});
var end_shape__1 = (function (mode){
...
* value parameter.
*/
quil.core.exp = (function exp(val){
...
var fill_int = null;
var fill_int__1 = (function (rgb){
return quil.core.current_graphics.call(null).fill((rgb | (0)));
});
var fill_int__2 = (function (rgb,alpha){
return quil.core.current_graphics.call(null).fill((rgb | (0)),alpha);
});
...
var display_filter__1 = (function (mode){
...
var display_filter__2 = (function (mode,level){
...
*/
quil.core.frame_count = (function frame_count(){
return quil.sketch.current_applet.call(null).frameCount;
});
/**
* Returns the current framerate
*/
quil.core.current_frame_rate = (function current_frame_rate(){
...
*/
quil.core.frame_rate = (function frame_rate(new_rate){
...
*/
quil.core.frustum = (function frustum(left,right,bottom,top,near,far){
...
var get_pixel = null;
var get_pixel__0 = (function (){
return get_pixel.call(null,quil.core.current_graphics.call(null));
});
var get_pixel__1 = (function (img){
return img.get();
});
var get_pixel__2 = (function (x,y){
return get_pixel.call(null,quil.core.current_graphics.call(null),x,y);
});
var get_pixel__3 = (function (img,x,y){
return img.get((x | (0)),(y | (0)));
});
var get_pixel__4 = (function (x,y,w,h){
return get_pixel.call(null,quil.core.current_graphics.call(null),x,y,w,h);
});
var get_pixel__5 = (function (img,x,y,w,h){
...
*/
quil.core.green = (function green(col){
return quil.core.current_graphics.call(null).green((col | (0)));
});
/**
...
var hex = null;
var hex__1 = (function (val){
return quil.sketch.current_applet.call(null).hex(val);
});
var hex__2 = (function (val,num_digits){
...
* size is called.
*/
quil.core.height = (function height(){
...
*/
quil.core.hint = (function hint(hint_type){
...
*/
quil.core.hour = (function hour(){
return quil.sketch.current_applet.call(null).hour();
});
/**
* Extracts the hue value from a color.
*/
quil.core.hue = (function hue(col){
return quil.core.current_graphics.call(null).hue((col | (0)));
});
/**
...
var image = null;
var image__3 = (function (img,x,y){
return quil.core.current_graphics.call(null).image(img,x,y);
});
var image__5 = (function (img,x,y,c,d){
...
var image_filter__2 = (function (img,mode){
var mode__$1 = quil.util.resolve_constant_key.call(null,mode,quil.core.filter_modes);
return img.filter((mode__$1 | (0)));
});
var image_filter__3 = (function (img,mode,level){
var mode__$1 = quil.util.resolve_constant_key.call(null,mode,quil.core.filter_modes);
...
*/
quil.core.image_mode = (function image_mode(mode){
...
*/
quil.core.light_falloff = (function light_falloff(constant,linear,quadratic){
...
*/
quil.core.lerp_color = (function lerp_color(c1,c2,amt){
return quil.core.current_graphics.call(null).lerpColor((c1 | (0)),(c2 | (0)),amt);
});
/**
...
*/
quil.core.lerp = (function lerp(start,stop,amt){
...
* loop.
*/
quil.core.lights = (function lights(){
...
* shininess functions.
*/
quil.core.light_specular = (function light_specular(r,g,b){
...
var line = null;
var line__2 = (function (p1,p2){
return cljs.core.apply.call(null,line,cljs.core.concat.call(null,p1,p2));
});
var line__4 = (function (x1,y1,x2,y2){
return quil.core.current_graphics.call(null).line(x1,y1,x2,y2);
});
var line__6 = (function (x1,y1,z1,x2,y2,z2){
...
*/
quil.core.load_font = (function load_font(filename){
...
*/
quil.core.load_image = (function load_image(filename){
...
var load_shader__1 = (function (fragment_filename){
return quil.core.current_graphics.call(null).loadShader(fragment_filename);
});
var load_shader__2 = (function (fragment_filename,vertex_filename){
...
*/
quil.core.load_shape = (function load_shape(filename){
...
*/
quil.core.log = (function log(val){
...
*/
quil.core.map_range = (function map_range(val,low1,high1,low2,high2){
...
* animation sequences.
*/
quil.core.millis = (function millis(){
return quil.sketch.current_applet.call(null).millis();
});
/**
* Returns the current minute as a value from 0 - 59
*/
quil.core.minute = (function minute(){
...
*/
quil.core.model_x = (function model_x(x,y,z){
...
* original point once the transformations are no longer in use.
*/
quil.core.model_y = (function model_y(x,y,z){
...
* original point once the transformations are no longer in use.
*/
quil.core.model_z = (function model_z(x,y,z){
return quil.core.current_graphics.call(null).modelZ(x,y,z);
});
/**
* Returns the current month as a value from 1 - 12.
*/
quil.core.month = (function month(){
...
*/
quil.core.mouse_button = (function mouse_button(){
var button_code = quil.sketch.current_applet.call(null).mouseButton;
var pred__11988 = cljs.core._EQ_;
var expr__11989 = button_code;
if(cljs.core.truth_(pred__11988.call(null,(37),expr__11989))){
return new cljs.core.Keyword(null,"left","left",-399115937);
} else {
if(cljs.core.truth_(pred__11988.call(null,(39),expr__11989))){
return new cljs.core.Keyword(null,"right","right",-452581833);
} else {
if(cljs.core.truth_(pred__11988.call(null,(3),expr__11989))){
...
* screen (Present) mode.
*/
quil.core.no_cursor = (function no_cursor(){
...
*/
quil.core.no_fill = (function no_fill(){
...
var noise_detail__1 = (function (octaves){
return quil.sketch.current_applet.call(null).noiseDetail((octaves | (0)));
});
var noise_detail__2 = (function (octaves,falloff){
...
* software is run.
*/
quil.core.noise_seed = (function noise_seed(val){
...
*/
quil.core.no_lights = (function no_lights(){
...
* loop was called.
*/
quil.core.no_loop = (function no_loop(){
return quil.sketch.current_applet.call(null).noLoop();
});
/**
* Normalize a value to exist between 0 and 1 (inclusive).
*/
quil.core.norm = (function norm(val,start,stop){
...
*/
quil.core.normal = (function normal(nx,ny,nz){
return quil.core.current_graphics.call(null).normal(nx,ny,nz);
});
/**
* Draws all geometry with jagged (aliased) edges.
*/
quil.core.no_smooth = (function no_smooth(){
...
*/
quil.core.no_stroke = (function no_stroke(){
...
*/
quil.core.no_tint = (function no_tint(){
...
var perspective__0 = (function (){
return quil.core.current_graphics.call(null).perspective();
});
var perspective__4 = (function (fovy,aspect,z_near,z_far){
...
var pixels = null;
var pixels__0 = (function (){
return pixels.call(null,quil.core.current_graphics.call(null));
});
var pixels__1 = (function (img){
img.loadPixels();
...
*/
quil.core.point_light = (function point_light(r,g,b,x,y,z){
...
*/
quil.core.pop_matrix = (function pop_matrix(){
...
* control
*/
quil.core.pop_style = (function pop_style(){
...
*/
quil.core.pow = (function pow(num,exponent){
...
* debugging
*/
quil.core.print_projection = (function print_projection(){
...
* transformations.
*/
quil.core.push_matrix = (function push_matrix(){
...
*/
quil.core.push_style = (function push_style(){
...
*/
quil.core.quad = (function quad(x1,y1,x2,y2,x3,y3,x4,y4){
...
var quadratic_vertex__4 = (function (cx,cy,x3,y3){
return quil.core.current_graphics.call(null).quadraticVertex(cx,cy,x3,y3);
});
var quadratic_vertex__6 = (function (cx,cy,cz,x3,y3,z3){
...
* radians.
*/
quil.core.radians = (function radians(degrees){
...
*/
quil.core.random_gaussian = (function random_gaussian(){
...
*/
quil.core.random_seed = (function random_seed(w){
...
*/
quil.core.raw_key = (function raw_key(){
...
var rect = null;
var rect__4 = (function (x,y,width,height){
return quil.core.current_graphics.call(null).rect(x,y,width,height);
});
var rect__5 = (function (x,y,width,height,r){
return quil.core.current_graphics.call(null).rect(x,y,width,height,r);
});
var rect__8 = (function (x,y,width,height,top_left_r,top_right_r,bottom_right_r,bottom_left_r){
...
* image's width and height.
*/
quil.core.rect_mode = (function rect_mode(mode){
...
*/
quil.core.red = (function red(c){
return quil.core.current_graphics.call(null).red((c | (0)));
});
/**
...
*/
quil.core.redraw = (function redraw(){
...
* performance.
*/
quil.core.request_image = (function request_image(filename){
...
*/
quil.core.reset_matrix = (function reset_matrix(){
...
*/
quil.core.resize = (function resize(img,w,h){
...
var rotate__4 = (function (angle,vx,vy,vz){
...
*/
quil.core.rotate_x = (function rotate_x(angle){
...
* function requires either the :p3d or :opengl renderer.
*/
quil.core.rotate_y = (function rotate_y(angle){
...
* function requires either the :p3d or :opengl renderer.
*/
quil.core.rotate_z = (function rotate_z(angle){
...
*/
quil.core.round = (function round(val){
return quil.sketch.current_applet.call(null).round(val);
});
/**
* Extracts the saturation value from a color.
*/
quil.core.saturation = (function saturation(c){
return quil.core.current_graphics.call(null).saturation((c | (0)));
});
/**
...
* create-graphics.
*/
quil.core.save = (function save(filename){
...
var save_frame = null;
var save_frame__0 = (function (){
return quil.sketch.current_applet.call(null).saveFrame();
});
var save_frame__1 = (function (name){
...
var screen_x = null;
var screen_x__2 = (function (x,y){
return quil.core.current_graphics.call(null).screenX(x,y);
});
var screen_x__3 = (function (x,y,z){
...
var screen_y = null;
var screen_y__2 = (function (x,y){
return quil.core.current_graphics.call(null).screenY(x,y);
});
var screen_y__3 = (function (x,y,z){
...
*/
quil.core.screen_z = (function screen_z(x,y,z){
return quil.core.current_graphics.call(null).screenZ(x,y,z);
});
/**
* Returns the current second as a value from 0 - 59.
*/
quil.core.seconds = (function seconds(){
...
var set_pixel = null;
var set_pixel__3 = (function (x,y,c){
return set_pixel.call(null,quil.core.current_graphics.call(null),x,y,c);
});
var set_pixel__4 = (function (img,x,y,c){
...
* image.
*/
quil.core.set_image = (function set_image(x,y,src){
...
*/
quil.core.shear_x = (function shear_x(angle){
...
* push-matrix and pop-matrix fns.
*/
quil.core.shear_y = (function shear_y(angle){
...
* height.
*/
quil.core.shape_mode = (function shape_mode(mode){
...
*/
quil.core.shininess = (function shininess(shine){
...
*/
quil.core.sin = (function sin(angle){
...
var smooth = null;
var smooth__0 = (function (){
return quil.core.current_graphics.call(null).smooth();
});
var smooth__1 = (function (level){
...
var specular = null;
var specular__1 = (function (gray){
return quil.core.current_graphics.call(null).specular(gray);
});
var specular__3 = (function (x,y,z){
...
*/
quil.core.sphere = (function sphere(radius){
...
var sphere_detail__1 = (function (res){
return quil.core.current_graphics.call(null).sphereDetail((res | (0)));
});
var sphere_detail__2 = (function (ures,vres){
...
var spot_light = null;
var spot_light__5 = (function (p__11991,p__11992,p__11993,angle,concentration){
var vec__11997 = p__11991;
var r = cljs.core.nth.call(null,vec__11997,(0),null);
var g = cljs.core.nth.call(null,vec__11997,(1),null);
var b = cljs.core.nth.call(null,vec__11997,(2),null);
var vec__11998 = p__11992;
var x = cljs.core.nth.call(null,vec__11998,(0),null);
var y = cljs.core.nth.call(null,vec__11998,(1),null);
var z = cljs.core.nth.call(null,vec__11998,(2),null);
var vec__11999 = p__11993;
var nx = cljs.core.nth.call(null,vec__11999,(0),null);
var ny = cljs.core.nth.call(null,vec__11999,(1),null);
var nz = cljs.core.nth.call(null,vec__11999,(2),null);
return quil.core.current_graphics.call(null).spotLight(r,g,b,x,y,z,nx,ny,nz,angle,concentration);
});
var spot_light__11 = (function (r,g,b,x,y,z,nx,ny,nz,angle,concentration){
return quil.core.current_graphics.call(null).spotLight(r,g,b,x,y,z,nx,ny,nz,angle,concentration);
});
...
*/
quil.core.sqrt = (function sqrt(a){
...
*/
quil.core.start_loop = (function start_loop(){
...
var stroke_int = null;
var stroke_int__1 = (function (rgb){
return quil.core.current_graphics.call(null).stroke((rgb | (0)));
});
var stroke_int__2 = (function (rgb,alpha){
return quil.core.current_graphics.call(null).stroke((rgb | (0)),alpha);
});
...
*/
quil.core.stroke_cap = (function stroke_cap(cap_mode){
...
* renderers.
*/
quil.core.stroke_join = (function stroke_join(join_mode){
...
*/
quil.core.stroke_weight = (function stroke_weight(weight){
...
var text_num = null;
var text_num__3 = (function (num,x,y){
return quil.core.current_graphics.call(null).text(num,x,y);
});
var text_num__4 = (function (num,x,y,z){
...
var text_align = null;
var text_align__1 = (function (align){
...
var text_align__2 = (function (align_x,align_y){
...
*/
quil.core.text_ascent = (function text_ascent(){
...
* values will give you the total height of the line.
*/
quil.core.text_descent = (function text_descent(){
...
var text_font = null;
var text_font__1 = (function (font){
return quil.core.current_graphics.call(null).textFont(font);
});
var text_font__2 = (function (font,size){
...
*/
quil.core.text_leading = (function text_leading(leading){
...
*/
quil.core.text_mode = (function text_mode(mode){
...
* units of pixels.
*/
quil.core.text_size = (function text_size(size){
...
* shape.
*/
quil.core.texture = (function texture(img){
...
*/
quil.core.texture_mode = (function texture_mode(mode){
...
*/
quil.core.text_width = (function text_width(data){
...
var tint_int = null;
var tint_int__1 = (function (rgb){
return quil.core.current_graphics.call(null).tint((rgb | (0)));
});
var tint_int__2 = (function (rgb,alpha){
return quil.core.current_graphics.call(null).tint((rgb | (0)),alpha);
});
...
var translate = null;
var translate__1 = (function (v){
return cljs.core.apply.call(null,translate,v);
});
var translate__2 = (function (tx,ty){
return quil.core.current_graphics.call(null).translate(tx,ty);
});
var translate__3 = (function (tx,ty,tz){
...
* third point.
*/
quil.core.triangle = (function triangle(x1,y1,x2,y2,x3,y3){
...
* integers to strings.
*/
quil.core.unbinary = (function unbinary(str_val){
...
*/
quil.core.unhex = (function unhex(hex_str){
...
var update_pixels__0 = (function (){
return update_pixels.call(null,quil.core.current_graphics.call(null));
});
var update_pixels__1 = (function (img){
var temp__4126__auto___12000 = img.stored_pix_array;
if(cljs.core.truth_(temp__4126__auto___12000)){
var pix_array_12001 = temp__4126__auto___12000;
img.pixels.set(pix_array_12001);
...
* called.
*/
quil.core.width = (function width(){
...
var opts = null;
if (arguments.length > 0) {
var G__12002__i = 0, G__12002__a = new Array(arguments.length -  0);
while (G__12002__i < G__12002__a.length) {G__12002__a[G__12002__i] = arguments[G__12002__i + 0]; ++G__12002__i;}
  opts = new cljs.core.IndexedSeq(G__12002__a,0);
} 
return sketch__delegate.call(this,opts);};
sketch.cljs$lang$maxFixedArity = 0;
sketch.cljs$lang$applyTo = (function (arglist__12003){
var opts = cljs.core.seq(arglist__12003);
...
*/
quil.core.key_coded_QMARK_ = (function key_coded_QMARK_(c){
...
* :shift, :command, :f1-24
*/
quil.core.key_as_keyword = (function key_as_keyword(){
