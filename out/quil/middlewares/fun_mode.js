...
quil.middlewares.fun_mode.wrap_setup = (function wrap_setup(options){
...
quil.middlewares.fun_mode.wrap_draw_update = (function wrap_draw_update(options){
...
quil.middlewares.fun_mode.mouse_event = (function mouse_event(){
...
quil.middlewares.fun_mode.mouse_event_full = (function mouse_event_full(){
...
quil.middlewares.fun_mode.key_event = (function key_event(){
...
quil.middlewares.fun_mode.wrap_handler = (function() {
var wrap_handler = null;
var wrap_handler__2 = (function (options,handler_key){
return wrap_handler.call(null,options,handler_key,null);
});
var wrap_handler__3 = (function (options,handler_key,event_fn){
var temp__4124__auto__ = options.call(null,handler_key);
if(cljs.core.truth_(temp__4124__auto__)){
var handler = temp__4124__auto__;
return cljs.core.assoc.call(null,options,handler_key,(cljs.core.truth_(event_fn)?((function (handler,temp__4124__auto__){
return (function (){
return cljs.core.swap_BANG_.call(null,quil.core.state_atom.call(null),handler,event_fn.call(null));
});})(handler,temp__4124__auto__))
:((function (handler,temp__4124__auto__){
return (function (){
...
wrap_handler = function(options,handler_key,event_fn){
switch(arguments.length){
case 2:
return wrap_handler__2.call(this,options,handler_key);
case 3:
return wrap_handler__3.call(this,options,handler_key,event_fn);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
wrap_handler.cljs$core$IFn$_invoke$arity$2 = wrap_handler__2;
wrap_handler.cljs$core$IFn$_invoke$arity$3 = wrap_handler__3;
return wrap_handler;
})()
;
/**
* @param {...*} var_args
*/
quil.middlewares.fun_mode.wrap_handlers = (function() { 
var wrap_handlers__delegate = function (options,handlers){
...
var wrap_handlers = function (options,var_args){
var handlers = null;
if (arguments.length > 1) {
var G__12121__i = 0, G__12121__a = new Array(arguments.length -  1);
while (G__12121__i < G__12121__a.length) {G__12121__a[G__12121__i] = arguments[G__12121__i + 1]; ++G__12121__i;}
  handlers = new cljs.core.IndexedSeq(G__12121__a,0);
} 
return wrap_handlers__delegate.call(this,options,handlers);};
wrap_handlers.cljs$lang$maxFixedArity = 1;
wrap_handlers.cljs$lang$applyTo = (function (arglist__12122){
var options = cljs.core.first(arglist__12122);
var handlers = cljs.core.rest(arglist__12122);
...
;
quil.middlewares.fun_mode.wrap_mouse_wheel = (function wrap_mouse_wheel(options){
var temp__4124__auto__ = new cljs.core.Keyword(null,"mouse-wheel","mouse-wheel",1811662439).cljs$core$IFn$_invoke$arity$1(options);
if(cljs.core.truth_(temp__4124__auto__)){
var handler = temp__4124__auto__;
return cljs.core.assoc.call(null,options,new cljs.core.Keyword(null,"mouse-wheel","mouse-wheel",1811662439),((function (handler,temp__4124__auto__){
...
*/
quil.middlewares.fun_mode.fun_mode = (function fun_mode(options){
