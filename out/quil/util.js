...
*/
quil.util.no_fn = (function no_fn(){
return null;
});
/**
...
*/
quil.util.resolve_constant_key = (function resolve_constant_key(key,mappings){
...
*/
quil.util.length_of_longest_key = (function length_of_longest_key(m){
var or__3759__auto__ = cljs.core.last.call(null,cljs.core.sort.call(null,cljs.core.map.call(null,(function (p1__12006_SHARP_){
return p1__12006_SHARP_.length();
...
var gen_padding__1 = (function (len){
return gen_padding.call(null,"",len," ");
});
var gen_padding__2 = (function (len,pad){
return gen_padding.call(null,"",len,pad);
});
var gen_padding__3 = (function (s,len,pad){
if((len > (0))){
return gen_padding.call(null,[cljs.core.str(s),cljs.core.str(pad)].join(''),(len - (1)),pad);
} else {
return s;
}
});
...
;
quil.util.print_definition_list = (function print_definition_list(definitions){
...
quil.util.prepare_quil_name = (function prepare_quil_name(const_keyword){
